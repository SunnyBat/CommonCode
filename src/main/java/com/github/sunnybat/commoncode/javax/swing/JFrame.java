...
/**
 * A wrapper class for javax.swing.JFrame. Includes methods that are common to
 * almost all of my GUIs.
 *
 * @author SunnyBat
 */
public abstract class JFrame extends javax.swing.JFrame {
    ...
    /**
     * Invokes the given Runnable on the Event Dispatch Thread and waits for it
     * to finish.
     *
    ...
    /**
     * Shows the current window in the center of the screen. Executes on the EDT
     * and blocks until the GUI is visible.
     */
    ...
    /**
     * Sets the icon to display when the window is minimized to the tray. If
     * programName or trayIcon is set to null, minimizing to the tray is
     * disabled.
     *
     * @param programName The name to display when hovering over the icon in the
     * System Tray
    ...
    /**
     * Gets the PopupMenu to display when right clicking on the icon in the
     * System Tray. This will never be null.
     *
    ...
    /**
     * Minimizes the program to the System Tray if possible. If the System Tray
     * is not supported or a tray icon has not been set, this method does
     * nothing.
     */
    ...
    /**
     * Disposes the window as normal. Also removes the window's icon from the
     * System Tray if present.
     */
    @Override
    public void dispose() {
        if (tray != null) {
